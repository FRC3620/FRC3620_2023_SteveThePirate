...
public class CannonLocation {
    ...
    public static CannonLocation backwardsFloorPickupLocation = new CannonLocation(183.847, 0.0, 43.88); //elev: 183.22, pitch: 39.29
    public static CannonLocation lizardTonguePickupLocation = new CannonLocation(179.790, 18.234, 48.57);
