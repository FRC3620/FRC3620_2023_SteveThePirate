...
public class SeeConeCommand extends CommandBase {
  Logger logger = EventLogging.getLogger(getClass(), Level.INFO);

  FrontCameraMode savedCameraMode;

  public SeeConeCommand() {
    addRequirements(RobotContainer.visionSubsystem);
  }

  @Override
  public void initialize() {
    savedCameraMode = RobotContainer.visionSubsystem.setFrontCameraMode(FrontCameraMode.CONES);
