...
public class Human2BackwardsGrabNoBalanceAuto extends SequentialCommandGroup {
  ...
  public Human2BackwardsGrabNoBalanceAuto(DriveSubsystem driveSubsystem, CannonSubsystem cannonSubsystem, VisionSubsystem visionSubsystem, OdometrySubsystem odometrySubsystem) {
    ...
    addCommands(
      ...
      ,
      new SetCannonLocationCommand(CannonLocation.lizardTonguePickupLocation)
      //,
      //new WaitCommand(660)
      ,
      new ParallelRaceGroup(
        //change speed for this definitely
        new DriveToCoordinateCommand(FieldLocation.humanPickupBehindPost, .25, 0.1, 180, driveSubsystem) //was .25 speed
        ,
        new CannonClawInCommand(cannonSubsystem, 0.8) //0.3
      )
      ,
      new ParallelDeadlineGroup(
      ...
      new ParallelDeadlineGroup(
        ...
        ,
        new SequentialCommandGroup(
          new DriveToCoordinateCommand(FieldLocation.humanAltPointChangeX, 0.8, 0.15, 180, driveSubsystem)
          ,
          new DriveToCoordinateCommand(FieldLocation.humanCommunity, 0.7, 0.15, 180, driveSubsystem)
        )
      )
      ,
