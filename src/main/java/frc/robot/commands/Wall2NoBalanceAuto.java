...
public class Wall2NoBalanceAuto extends SequentialCommandGroup {
  /** Creates a new Human2NoBalanceAuto. */
  public Wall2NoBalanceAuto(DriveSubsystem driveSubsystem, VisionSubsystem visionSubsystem, CannonSubsystem cannonSubsystem, OdometrySubsystem odometrySubsystem) {
