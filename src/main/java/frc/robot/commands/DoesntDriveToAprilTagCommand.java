...
public class DoesntDriveToAprilTagCommand extends CommandBase {
  boolean end = false;
  ...
  public DoesntDriveToAprilTagCommand(DriveSubsystem driveSubsystem, VisionSubsystem visionSubsystem) {
