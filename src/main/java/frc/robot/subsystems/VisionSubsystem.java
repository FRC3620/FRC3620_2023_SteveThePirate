...
public class VisionSubsystem extends SubsystemBase {
  ...
  public PhotonPipelineResult getLastFrontCameraAprilTagsResult(double timestampSeconds) {
    if (lastFrontCameraAprilTagsResult != null) {
      double ts = lastFrontCameraAprilTagsResult.getTimestampSeconds();
      // System.out.println ("got result with " + ts);
